...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("C1.Android.Core.ScaleGestureListener, C1.Android.Core, Version=2.3.20171.134, Culture=neutral, PublicKeyToken=null", ScaleGestureListener.class, __md_methods);
	}


	public ScaleGestureListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == ScaleGestureListener.class)
			mono.android.TypeManager.Activate ("C1.Android.Core.ScaleGestureListener, C1.Android.Core, Version=2.3.20171.134, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
