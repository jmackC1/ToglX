...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("C1.Android.Core.GestureListener, C1.Android.Core, Version=2.3.20171.134, Culture=neutral, PublicKeyToken=null", GestureListener.class, __md_methods);
	}
	...
	public GestureListener () throws java.lang.Throwable
	{
		...
		if (getClass () == GestureListener.class)
			mono.android.TypeManager.Activate ("C1.Android.Core.GestureListener, C1.Android.Core, Version=2.3.20171.134, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
