...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("C1.Android.Core.LayoutChangeListener, C1.Android.Core, Version=2.3.20171.134, Culture=neutral, PublicKeyToken=null", LayoutChangeListener.class, __md_methods);
	}


	public LayoutChangeListener () throws java.lang.Throwable
	{
		super ();
		if (getClass () == LayoutChangeListener.class)
			mono.android.TypeManager.Activate ("C1.Android.Core.LayoutChangeListener, C1.Android.Core, Version=2.3.20171.134, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
